...
import { setForgetFormProp as setSignupFormProp } from '../../redux/actions'

const ForgetInput = forwardRef( (props, ref) => {

    const {propName, placeholder, type} = props

    const signupForm = useSelector(state=>state.forgetForm)
